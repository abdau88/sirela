...
define(PROJECT_NAMESPACE . "RANDOM_KEY", 'tsGmOuibLNGe9yj5'); // Random key for encryption
...
$PROJECT_ID = "{AEBA4D74-5D9D-43A3-BDE2-1E8D7036857C}"; // Project ID (GUID)
$RELATED_PROJECT_ID = "";
...
$CONNECTIONS["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "", "db" => "sirela", "qs" => "`", "qe" => "`");
...
define(PROJECT_NAMESPACE . "USER_TABLE_NAME", "tb_user");
...
define(PROJECT_NAMESPACE . "USER_LEVEL_FIELD_NAME", "role");

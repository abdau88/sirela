...
// Create page object
$tb_kegiatan_sub5_edit = new tb_kegiatan_sub5_edit();

// Run the page
$tb_kegiatan_sub5_edit->run();
...
$tb_kegiatan_sub5_edit->Page_Render();
?>
...
var ftb_kegiatan_sub5edit = currentForm = new ew.Form("ftb_kegiatan_sub5edit", "edit");

// Validate form
ftb_kegiatan_sub5edit.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($tb_kegiatan_sub5_edit->kode_kegiatan_sub5->Required) { ?>
		...
		<?php } ?>
		<?php if ($tb_kegiatan_sub5_edit->nama_kegiatan_sub5->Required) { ?>
		...
		<?php } ?>
		<?php if ($tb_kegiatan_sub5_edit->kode_kegiatan_sub6->Required) { ?>
...
ftb_kegiatan_sub5edit.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
ftb_kegiatan_sub5edit.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
ftb_kegiatan_sub5edit.lists["x_kode_kegiatan_sub6"] = <?php echo $tb_kegiatan_sub5_edit->kode_kegiatan_sub6->Lookup->toClientList() ?>;
ftb_kegiatan_sub5edit.lists["x_kode_kegiatan_sub6"].options = <?php echo JsonEncode($tb_kegiatan_sub5_edit->kode_kegiatan_sub6->lookupOptions()) ?>;
ftb_kegiatan_sub5edit.autoSuggests["x_kode_kegiatan_sub6"] = <?php echo json_encode(["data" => "ajax=autosuggest"]) ?>;
...
<?php $tb_kegiatan_sub5_edit->showPageHeader(); ?>
<?php
$tb_kegiatan_sub5_edit->showMessage();
?>
<form name="ftb_kegiatan_sub5edit" id="ftb_kegiatan_sub5edit" class="<?php echo $tb_kegiatan_sub5_edit->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($tb_kegiatan_sub5_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $tb_kegiatan_sub5_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="tb_kegiatan_sub5">
<input type="hidden" name="action" id="action" value="update">
<input type="hidden" name="modal" value="<?php echo (int)$tb_kegiatan_sub5_edit->IsModal ?>">
...
<?php if ($tb_kegiatan_sub5->kode_kegiatan_sub5->Visible) { // kode_kegiatan_sub5 ?>
	<div id="r_kode_kegiatan_sub5" class="form-group row">
		<label id="elh_tb_kegiatan_sub5_kode_kegiatan_sub5" for="x_kode_kegiatan_sub5" class="<?php echo $tb_kegiatan_sub5_edit->LeftColumnClass ?>"><?php echo $tb_kegiatan_sub5->kode_kegiatan_sub5->caption() ?><?php echo ($tb_kegiatan_sub5->kode_kegiatan_sub5->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $tb_kegiatan_sub5_edit->RightColumnClass ?>"><div<?php echo $tb_kegiatan_sub5->kode_kegiatan_sub5->cellAttributes() ?>>
...
<input type="hidden" data-table="tb_kegiatan_sub5" data-field="x_kode_kegiatan_sub5" name="x_kode_kegiatan_sub5" id="x_kode_kegiatan_sub5" value="<?php echo HtmlEncode($tb_kegiatan_sub5->kode_kegiatan_sub5->CurrentValue) ?>">
...
<?php if ($tb_kegiatan_sub5->nama_kegiatan_sub5->Visible) { // nama_kegiatan_sub5 ?>
	<div id="r_nama_kegiatan_sub5" class="form-group row">
		<label id="elh_tb_kegiatan_sub5_nama_kegiatan_sub5" for="x_nama_kegiatan_sub5" class="<?php echo $tb_kegiatan_sub5_edit->LeftColumnClass ?>"><?php echo $tb_kegiatan_sub5->nama_kegiatan_sub5->caption() ?><?php echo ($tb_kegiatan_sub5->nama_kegiatan_sub5->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $tb_kegiatan_sub5_edit->RightColumnClass ?>"><div<?php echo $tb_kegiatan_sub5->nama_kegiatan_sub5->cellAttributes() ?>>
...
<?php if ($tb_kegiatan_sub5->kode_kegiatan_sub6->Visible) { // kode_kegiatan_sub6 ?>
	<div id="r_kode_kegiatan_sub6" class="form-group row">
		<label id="elh_tb_kegiatan_sub5_kode_kegiatan_sub6" class="<?php echo $tb_kegiatan_sub5_edit->LeftColumnClass ?>"><?php echo $tb_kegiatan_sub5->kode_kegiatan_sub6->caption() ?><?php echo ($tb_kegiatan_sub5->kode_kegiatan_sub6->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $tb_kegiatan_sub5_edit->RightColumnClass ?>"><div<?php echo $tb_kegiatan_sub5->kode_kegiatan_sub6->cellAttributes() ?>>
...
<script>
ftb_kegiatan_sub5edit.createAutoSuggest({"id":"x_kode_kegiatan_sub6","forceSelect":false});
</script>
...
<?php
	if (in_array("tb_kegiatan_sub4", explode(",", $tb_kegiatan_sub5->getCurrentDetailTable())) && $tb_kegiatan_sub4->DetailEdit) {
?>
...
<?php } ?>
<?php if (!$tb_kegiatan_sub5_edit->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $tb_kegiatan_sub5_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit"><?php echo $Language->phrase("SaveBtn") ?></button>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $tb_kegiatan_sub5_edit->getReturnUrl() ?>"><?php echo $Language->phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<?php
$tb_kegiatan_sub5_edit->showPageFooter();
if (DEBUG_ENABLED)
...
<?php
$tb_kegiatan_sub5_edit->terminate();
?>
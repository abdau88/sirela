...
// Create page object
$tb_kegiatan_sub1_add = new tb_kegiatan_sub1_add();

// Run the page
$tb_kegiatan_sub1_add->run();
...
$tb_kegiatan_sub1_add->Page_Render();
?>
...
var ftb_kegiatan_sub1add = currentForm = new ew.Form("ftb_kegiatan_sub1add", "add");

// Validate form
ftb_kegiatan_sub1add.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($tb_kegiatan_sub1_add->kode_kegiatan_sub1->Required) { ?>
		...
		<?php } ?>
		<?php if ($tb_kegiatan_sub1_add->nama_kegiatan_sub1->Required) { ?>
		...
		<?php } ?>
		<?php if ($tb_kegiatan_sub1_add->kode_kegiatan_sub2->Required) { ?>
...
ftb_kegiatan_sub1add.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
ftb_kegiatan_sub1add.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
ftb_kegiatan_sub1add.lists["x_kode_kegiatan_sub2"] = <?php echo $tb_kegiatan_sub1_add->kode_kegiatan_sub2->Lookup->toClientList() ?>;
ftb_kegiatan_sub1add.lists["x_kode_kegiatan_sub2"].options = <?php echo JsonEncode($tb_kegiatan_sub1_add->kode_kegiatan_sub2->lookupOptions()) ?>;
ftb_kegiatan_sub1add.autoSuggests["x_kode_kegiatan_sub2"] = <?php echo json_encode(["data" => "ajax=autosuggest"]) ?>;
...
<?php $tb_kegiatan_sub1_add->showPageHeader(); ?>
<?php
$tb_kegiatan_sub1_add->showMessage();
?>
<form name="ftb_kegiatan_sub1add" id="ftb_kegiatan_sub1add" class="<?php echo $tb_kegiatan_sub1_add->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($tb_kegiatan_sub1_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $tb_kegiatan_sub1_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="tb_kegiatan_sub1">
<input type="hidden" name="action" id="action" value="insert">
<input type="hidden" name="modal" value="<?php echo (int)$tb_kegiatan_sub1_add->IsModal ?>">
...
<?php if ($tb_kegiatan_sub1->kode_kegiatan_sub1->Visible) { // kode_kegiatan_sub1 ?>
	<div id="r_kode_kegiatan_sub1" class="form-group row">
		<label id="elh_tb_kegiatan_sub1_kode_kegiatan_sub1" for="x_kode_kegiatan_sub1" class="<?php echo $tb_kegiatan_sub1_add->LeftColumnClass ?>"><?php echo $tb_kegiatan_sub1->kode_kegiatan_sub1->caption() ?><?php echo ($tb_kegiatan_sub1->kode_kegiatan_sub1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $tb_kegiatan_sub1_add->RightColumnClass ?>"><div<?php echo $tb_kegiatan_sub1->kode_kegiatan_sub1->cellAttributes() ?>>
<span id="el_tb_kegiatan_sub1_kode_kegiatan_sub1">
<input type="text" data-table="tb_kegiatan_sub1" data-field="x_kode_kegiatan_sub1" name="x_kode_kegiatan_sub1" id="x_kode_kegiatan_sub1" size="30" maxlength="40" placeholder="<?php echo HtmlEncode($tb_kegiatan_sub1->kode_kegiatan_sub1->getPlaceHolder()) ?>" value="<?php echo $tb_kegiatan_sub1->kode_kegiatan_sub1->EditValue ?>"<?php echo $tb_kegiatan_sub1->kode_kegiatan_sub1->editAttributes() ?>>
</span>
...
<?php if ($tb_kegiatan_sub1->nama_kegiatan_sub1->Visible) { // nama_kegiatan_sub1 ?>
	<div id="r_nama_kegiatan_sub1" class="form-group row">
		<label id="elh_tb_kegiatan_sub1_nama_kegiatan_sub1" for="x_nama_kegiatan_sub1" class="<?php echo $tb_kegiatan_sub1_add->LeftColumnClass ?>"><?php echo $tb_kegiatan_sub1->nama_kegiatan_sub1->caption() ?><?php echo ($tb_kegiatan_sub1->nama_kegiatan_sub1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $tb_kegiatan_sub1_add->RightColumnClass ?>"><div<?php echo $tb_kegiatan_sub1->nama_kegiatan_sub1->cellAttributes() ?>>
...
<?php if ($tb_kegiatan_sub1->kode_kegiatan_sub2->Visible) { // kode_kegiatan_sub2 ?>
	<div id="r_kode_kegiatan_sub2" class="form-group row">
		<label id="elh_tb_kegiatan_sub1_kode_kegiatan_sub2" class="<?php echo $tb_kegiatan_sub1_add->LeftColumnClass ?>"><?php echo $tb_kegiatan_sub1->kode_kegiatan_sub2->caption() ?><?php echo ($tb_kegiatan_sub1->kode_kegiatan_sub2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $tb_kegiatan_sub1_add->RightColumnClass ?>"><div<?php echo $tb_kegiatan_sub1->kode_kegiatan_sub2->cellAttributes() ?>>
...
<script>
ftb_kegiatan_sub1add.createAutoSuggest({"id":"x_kode_kegiatan_sub2","forceSelect":false});
</script>
...
<?php
	if (in_array("tb_kegiatan", explode(",", $tb_kegiatan_sub1->getCurrentDetailTable())) && $tb_kegiatan->DetailAdd) {
?>
...
<?php } ?>
<?php if (!$tb_kegiatan_sub1_add->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $tb_kegiatan_sub1_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit"><?php echo $Language->phrase("AddBtn") ?></button>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $tb_kegiatan_sub1_add->getReturnUrl() ?>"><?php echo $Language->phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<?php
$tb_kegiatan_sub1_add->showPageFooter();
if (DEBUG_ENABLED)
...
<?php
$tb_kegiatan_sub1_add->terminate();
?>
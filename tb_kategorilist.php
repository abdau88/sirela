...
<div id="xsr_1" class="ew-row d-sm-flex">
	<div class="ew-quick-search input-group">
		<input type="text" name="<?php echo TABLE_BASIC_SEARCH ?>" id="<?php echo TABLE_BASIC_SEARCH ?>" class="form-control" value="<?php echo HtmlEncode($tb_kategori_list->BasicSearch->getKeyword()) ?>" placeholder="<?php echo HtmlEncode($Language->phrase("Search")) ?>">
...
<?php if ($tb_kategori->kode_kategori->Visible) { // kode_kategori ?>
	<?php if ($tb_kategori->sortUrl($tb_kategori->kode_kategori) == "") { ?>
		<th data-name="kode_kategori" class="<?php echo $tb_kategori->kode_kategori->headerCellClass() ?>"><div id="elh_tb_kategori_kode_kategori" class="tb_kategori_kode_kategori"><div class="ew-table-header-caption"><?php echo $tb_kategori->kode_kategori->caption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="kode_kategori" class="<?php echo $tb_kategori->kode_kategori->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event,'<?php echo $tb_kategori->SortUrl($tb_kategori->kode_kategori) ?>',1);"><div id="elh_tb_kategori_kode_kategori" class="tb_kategori_kode_kategori">
			<div class="ew-table-header-btn"><span class="ew-table-header-caption"><?php echo $tb_kategori->kode_kategori->caption() ?><?php echo $Language->phrase("SrchLegend") ?></span><span class="ew-table-header-sort"><?php if ($tb_kategori->kode_kategori->getSort() == "ASC") { ?><i class="fa fa-sort-up"></i><?php } elseif ($tb_kategori->kode_kategori->getSort() == "DESC") { ?><i class="fa fa-sort-down"></i><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
...
?>
	<?php if ($tb_kategori->kode_kategori->Visible) { // kode_kategori ?>
		<td data-name="kode_kategori"<?php echo $tb_kategori->kode_kategori->cellAttributes() ?>>
<span id="el<?php echo $tb_kategori_list->RowCnt ?>_tb_kategori_kode_kategori" class="tb_kategori_kode_kategori">
<span<?php echo $tb_kategori->kode_kategori->viewAttributes() ?>>
<?php echo $tb_kategori->kode_kategori->getViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($tb_kategori->nama_kategori->Visible) { // nama_kategori ?>

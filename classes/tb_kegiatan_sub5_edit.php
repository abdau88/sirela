 ...
 * Page class
 */
class tb_kegiatan_sub5_edit extends tb_kegiatan_sub5
{
	...
	// Page object name
	public $PageObjName = "tb_kegiatan_sub5_edit";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			// Load key from Form
			if ($CurrentForm->hasValue("x_kode_kegiatan_sub5")) {
				$this->kode_kegiatan_sub5->setFormValue($CurrentForm->getValue("x_kode_kegiatan_sub5"));
			}
		} else {
	...
	protected function validateForm()
	{
		...
		if (in_array("tb_kegiatan_sub4", $detailTblVar) && $GLOBALS["tb_kegiatan_sub4"]->DetailEdit) {
			...
			if ($updateRow) {
				...
				if ($editRow) {
					if (in_array("tb_kegiatan_sub4", $detailTblVar) && $GLOBALS["tb_kegiatan_sub4"]->DetailEdit) {
						if (!isset($GLOBALS["tb_kegiatan_sub4_grid"]))
							$GLOBALS["tb_kegiatan_sub4_grid"] = new tb_kegiatan_sub4_grid(); // Get detail page object
						$editRow = $GLOBALS["tb_kegiatan_sub4_grid"]->gridUpdate();
					}
				}
		...
		if ($detailTblVar <> "") {
			...
			if (in_array("tb_kegiatan_sub4", $detailTblVar)) {
				...
				if ($GLOBALS["tb_kegiatan_sub4_grid"]->DetailEdit) {
					$GLOBALS["tb_kegiatan_sub4_grid"]->CurrentMode = "edit";
					$GLOBALS["tb_kegiatan_sub4_grid"]->CurrentAction = "gridedit";

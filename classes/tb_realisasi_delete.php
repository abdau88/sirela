 ...
 * Page class
 */
class tb_realisasi_delete extends tb_realisasi
{
	...
	// Page object name
	public $PageObjName = "tb_realisasi_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("tb_realisasilist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("tb_realisasilist.php"); // Return to list
			}
		}
	}

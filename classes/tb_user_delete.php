 ...
 * Page class
 */
class tb_user_delete extends tb_user
{
	...
	// Page object name
	public $PageObjName = "tb_user_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("tb_userlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("tb_userlist.php"); // Return to list
			}
		}
	}

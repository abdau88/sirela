 ...
 * Page class
 */
class tb_kegiatan_sub3_delete extends tb_kegiatan_sub3
{
	...
	// Page object name
	public $PageObjName = "tb_kegiatan_sub3_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("tb_kegiatan_sub3list.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("tb_kegiatan_sub3list.php"); // Return to list
			}
		}
	}

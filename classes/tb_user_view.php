 ...
 * Page class
 */
class tb_user_view extends tb_user
{
	...
	// Page object name
	public $PageObjName = "tb_user_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("username") !== NULL) {
				...
				$returnUrl = "tb_userlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "tb_userlist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "tb_userlist.php"; // Not page request, return to list
		}
		if ($returnUrl <> "") {

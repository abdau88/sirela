 ...
 * Page class
 */
class tb_kegiatan_sub5_delete extends tb_kegiatan_sub5
{
	...
	// Page object name
	public $PageObjName = "tb_kegiatan_sub5_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("tb_kegiatan_sub5list.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("tb_kegiatan_sub5list.php"); // Return to list
			}
		}
	}

...
// Create page object
$tb_kegiatan_sub4_edit = new tb_kegiatan_sub4_edit();

// Run the page
$tb_kegiatan_sub4_edit->run();
...
$tb_kegiatan_sub4_edit->Page_Render();
?>
...
var ftb_kegiatan_sub4edit = currentForm = new ew.Form("ftb_kegiatan_sub4edit", "edit");

// Validate form
ftb_kegiatan_sub4edit.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($tb_kegiatan_sub4_edit->kode_kegiatan_sub4->Required) { ?>
		...
		<?php } ?>
		<?php if ($tb_kegiatan_sub4_edit->nama_kegiatan_sub4->Required) { ?>
		...
		<?php } ?>
		<?php if ($tb_kegiatan_sub4_edit->kode_kegiatan_sub5->Required) { ?>
...
ftb_kegiatan_sub4edit.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
ftb_kegiatan_sub4edit.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
ftb_kegiatan_sub4edit.lists["x_kode_kegiatan_sub5"] = <?php echo $tb_kegiatan_sub4_edit->kode_kegiatan_sub5->Lookup->toClientList() ?>;
ftb_kegiatan_sub4edit.lists["x_kode_kegiatan_sub5"].options = <?php echo JsonEncode($tb_kegiatan_sub4_edit->kode_kegiatan_sub5->lookupOptions()) ?>;
ftb_kegiatan_sub4edit.autoSuggests["x_kode_kegiatan_sub5"] = <?php echo json_encode(["data" => "ajax=autosuggest"]) ?>;
...
<?php $tb_kegiatan_sub4_edit->showPageHeader(); ?>
<?php
$tb_kegiatan_sub4_edit->showMessage();
?>
<form name="ftb_kegiatan_sub4edit" id="ftb_kegiatan_sub4edit" class="<?php echo $tb_kegiatan_sub4_edit->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($tb_kegiatan_sub4_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $tb_kegiatan_sub4_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="tb_kegiatan_sub4">
<input type="hidden" name="action" id="action" value="update">
<input type="hidden" name="modal" value="<?php echo (int)$tb_kegiatan_sub4_edit->IsModal ?>">
...
<?php if ($tb_kegiatan_sub4->kode_kegiatan_sub4->Visible) { // kode_kegiatan_sub4 ?>
	<div id="r_kode_kegiatan_sub4" class="form-group row">
		<label id="elh_tb_kegiatan_sub4_kode_kegiatan_sub4" for="x_kode_kegiatan_sub4" class="<?php echo $tb_kegiatan_sub4_edit->LeftColumnClass ?>"><?php echo $tb_kegiatan_sub4->kode_kegiatan_sub4->caption() ?><?php echo ($tb_kegiatan_sub4->kode_kegiatan_sub4->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $tb_kegiatan_sub4_edit->RightColumnClass ?>"><div<?php echo $tb_kegiatan_sub4->kode_kegiatan_sub4->cellAttributes() ?>>
...
<input type="hidden" data-table="tb_kegiatan_sub4" data-field="x_kode_kegiatan_sub4" name="x_kode_kegiatan_sub4" id="x_kode_kegiatan_sub4" value="<?php echo HtmlEncode($tb_kegiatan_sub4->kode_kegiatan_sub4->CurrentValue) ?>">
...
<?php if ($tb_kegiatan_sub4->nama_kegiatan_sub4->Visible) { // nama_kegiatan_sub4 ?>
	<div id="r_nama_kegiatan_sub4" class="form-group row">
		<label id="elh_tb_kegiatan_sub4_nama_kegiatan_sub4" for="x_nama_kegiatan_sub4" class="<?php echo $tb_kegiatan_sub4_edit->LeftColumnClass ?>"><?php echo $tb_kegiatan_sub4->nama_kegiatan_sub4->caption() ?><?php echo ($tb_kegiatan_sub4->nama_kegiatan_sub4->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $tb_kegiatan_sub4_edit->RightColumnClass ?>"><div<?php echo $tb_kegiatan_sub4->nama_kegiatan_sub4->cellAttributes() ?>>
...
<?php if ($tb_kegiatan_sub4->kode_kegiatan_sub5->Visible) { // kode_kegiatan_sub5 ?>
	<div id="r_kode_kegiatan_sub5" class="form-group row">
		<label id="elh_tb_kegiatan_sub4_kode_kegiatan_sub5" class="<?php echo $tb_kegiatan_sub4_edit->LeftColumnClass ?>"><?php echo $tb_kegiatan_sub4->kode_kegiatan_sub5->caption() ?><?php echo ($tb_kegiatan_sub4->kode_kegiatan_sub5->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $tb_kegiatan_sub4_edit->RightColumnClass ?>"><div<?php echo $tb_kegiatan_sub4->kode_kegiatan_sub5->cellAttributes() ?>>
...
<script>
ftb_kegiatan_sub4edit.createAutoSuggest({"id":"x_kode_kegiatan_sub5","forceSelect":false});
</script>
...
<?php
	if (in_array("tb_kegiatan_sub3", explode(",", $tb_kegiatan_sub4->getCurrentDetailTable())) && $tb_kegiatan_sub3->DetailEdit) {
?>
...
<?php } ?>
<?php if (!$tb_kegiatan_sub4_edit->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $tb_kegiatan_sub4_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit"><?php echo $Language->phrase("SaveBtn") ?></button>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $tb_kegiatan_sub4_edit->getReturnUrl() ?>"><?php echo $Language->phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<?php
$tb_kegiatan_sub4_edit->showPageFooter();
if (DEBUG_ENABLED)
...
<?php
$tb_kegiatan_sub4_edit->terminate();
?>
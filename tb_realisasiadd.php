...
// Create page object
$tb_realisasi_add = new tb_realisasi_add();

// Run the page
$tb_realisasi_add->run();
...
var ftb_realisasiadd = currentForm = new ew.Form("ftb_realisasiadd", "add");

// Validate form
ftb_realisasiadd.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($tb_realisasi_add->kode_unit->Required) { ?>
		...
		<?php if ($tb_realisasi_add->kode_akun->Required) { ?>
		...
		<?php } ?>
		<?php if ($tb_realisasi_add->tahun->Required) { ?>
		...
		<?php } ?>
		<?php if ($tb_realisasi_add->pagu->Required) { ?>
		...
		<?php if ($tb_realisasi_add->realisasi->Required) { ?>
...
ftb_realisasiadd.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
ftb_realisasiadd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
ftb_realisasiadd.lists["x_kode_unit"] = <?php echo $tb_realisasi_add->kode_unit->Lookup->toClientList() ?>;
ftb_realisasiadd.lists["x_kode_unit"].options = <?php echo JsonEncode($tb_realisasi_add->kode_unit->lookupOptions()) ?>;
ftb_realisasiadd.autoSuggests["x_kode_unit"] = <?php echo json_encode(["data" => "ajax=autosuggest"]) ?>;
ftb_realisasiadd.lists["x_kode_akun"] = <?php echo $tb_realisasi_add->kode_akun->Lookup->toClientList() ?>;
ftb_realisasiadd.lists["x_kode_akun"].options = <?php echo JsonEncode($tb_realisasi_add->kode_akun->lookupOptions()) ?>;
ftb_realisasiadd.autoSuggests["x_kode_akun"] = <?php echo json_encode(["data" => "ajax=autosuggest"]) ?>;
ftb_realisasiadd.lists["x_tahun"] = <?php echo $tb_realisasi_add->tahun->Lookup->toClientList() ?>;
ftb_realisasiadd.lists["x_tahun"].options = <?php echo JsonEncode($tb_realisasi_add->tahun->options(FALSE, TRUE)) ?>;
...
<?php $tb_realisasi_add->showPageHeader(); ?>
<?php
$tb_realisasi_add->showMessage();
?>
<form name="ftb_realisasiadd" id="ftb_realisasiadd" class="<?php echo $tb_realisasi_add->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($tb_realisasi_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $tb_realisasi_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="tb_realisasi">
<input type="hidden" name="action" id="action" value="insert">
<input type="hidden" name="modal" value="<?php echo (int)$tb_realisasi_add->IsModal ?>">
<div class="ew-add-div"><!-- page* -->
<?php if ($tb_realisasi->kode_unit->Visible) { // kode_unit ?>
	<div id="r_kode_unit" class="form-group row">
		<label id="elh_tb_realisasi_kode_unit" class="<?php echo $tb_realisasi_add->LeftColumnClass ?>"><?php echo $tb_realisasi->kode_unit->caption() ?><?php echo ($tb_realisasi->kode_unit->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $tb_realisasi_add->RightColumnClass ?>"><div<?php echo $tb_realisasi->kode_unit->cellAttributes() ?>>
...
<script>
ftb_realisasiadd.createAutoSuggest({"id":"x_kode_unit","forceSelect":false});
</script>
...
<?php if ($tb_realisasi->kode_akun->Visible) { // kode_akun ?>
	<div id="r_kode_akun" class="form-group row">
		<label id="elh_tb_realisasi_kode_akun" class="<?php echo $tb_realisasi_add->LeftColumnClass ?>"><?php echo $tb_realisasi->kode_akun->caption() ?><?php echo ($tb_realisasi->kode_akun->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $tb_realisasi_add->RightColumnClass ?>"><div<?php echo $tb_realisasi->kode_akun->cellAttributes() ?>>
...
<script>
ftb_realisasiadd.createAutoSuggest({"id":"x_kode_akun","forceSelect":false});
</script>
...
<?php if ($tb_realisasi->tahun->Visible) { // tahun ?>
	<div id="r_tahun" class="form-group row">
		<label id="elh_tb_realisasi_tahun" for="x_tahun" class="<?php echo $tb_realisasi_add->LeftColumnClass ?>"><?php echo $tb_realisasi->tahun->caption() ?><?php echo ($tb_realisasi->tahun->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $tb_realisasi_add->RightColumnClass ?>"><div<?php echo $tb_realisasi->tahun->cellAttributes() ?>>
...
<?php if ($tb_realisasi->pagu->Visible) { // pagu ?>
	<div id="r_pagu" class="form-group row">
		<label id="elh_tb_realisasi_pagu" for="x_pagu" class="<?php echo $tb_realisasi_add->LeftColumnClass ?>"><?php echo $tb_realisasi->pagu->caption() ?><?php echo ($tb_realisasi->pagu->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $tb_realisasi_add->RightColumnClass ?>"><div<?php echo $tb_realisasi->pagu->cellAttributes() ?>>
...
<?php if ($tb_realisasi->realisasi->Visible) { // realisasi ?>
	<div id="r_realisasi" class="form-group row">
		<label id="elh_tb_realisasi_realisasi" for="x_realisasi" class="<?php echo $tb_realisasi_add->LeftColumnClass ?>"><?php echo $tb_realisasi->realisasi->caption() ?><?php echo ($tb_realisasi->realisasi->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $tb_realisasi_add->RightColumnClass ?>"><div<?php echo $tb_realisasi->realisasi->cellAttributes() ?>>
...
<?php if (!$tb_realisasi_add->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $tb_realisasi_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit"><?php echo $Language->phrase("AddBtn") ?></button>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $tb_realisasi_add->getReturnUrl() ?>"><?php echo $Language->phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<?php
$tb_realisasi_add->showPageFooter();
if (DEBUG_ENABLED)

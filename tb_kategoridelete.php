...
<?php if ($tb_kategori->kode_kategori->Visible) { // kode_kategori ?>
		<th class="<?php echo $tb_kategori->kode_kategori->headerCellClass() ?>"><span id="elh_tb_kategori_kode_kategori" class="tb_kategori_kode_kategori"><?php echo $tb_kategori->kode_kategori->caption() ?></span></th>
<?php } ?>
...
<?php if ($tb_kategori->kode_kategori->Visible) { // kode_kategori ?>
		<td<?php echo $tb_kategori->kode_kategori->cellAttributes() ?>>
<span id="el<?php echo $tb_kategori_delete->RowCnt ?>_tb_kategori_kode_kategori" class="tb_kategori_kode_kategori">

...
<link rel="shortcut icon" type="image/x-icon" href="<?php echo $RELATIVE_PATH ?>logopnc_znw_icon.ico"><link rel="icon" type="image/x-icon" href="<?php echo $RELATIVE_PATH ?>logopnc_znw_icon.ico">
...
<div class="wrapper ew-layout">
	...
	<aside class="<?php echo $SIDEBAR_CLASS ?>">
		...
		<a href="#" class="brand-link">
			<span class="brand-text">SIRELA PNC</span>
		</a>
		<!-- Sidebar -->
		<div class="sidebar">
			<!-- Sidebar Menu -->

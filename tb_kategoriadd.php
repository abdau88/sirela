...
ftb_kategoriadd.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($tb_kategori_add->kode_kategori->Required) { ?>
...
<?php if ($tb_kategori->kode_kategori->Visible) { // kode_kategori ?>
	<div id="r_kode_kategori" class="form-group row">
		<label id="elh_tb_kategori_kode_kategori" for="x_kode_kategori" class="<?php echo $tb_kategori_add->LeftColumnClass ?>"><?php echo $tb_kategori->kode_kategori->caption() ?><?php echo ($tb_kategori->kode_kategori->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $tb_kategori_add->RightColumnClass ?>"><div<?php echo $tb_kategori->kode_kategori->cellAttributes() ?>>
<span id="el_tb_kategori_kode_kategori">
<input type="text" data-table="tb_kategori" data-field="x_kode_kategori" name="x_kode_kategori" id="x_kode_kategori" size="30" maxlength="20" placeholder="<?php echo HtmlEncode($tb_kategori->kode_kategori->getPlaceHolder()) ?>" value="<?php echo $tb_kategori->kode_kategori->EditValue ?>"<?php echo $tb_kategori->kode_kategori->editAttributes() ?>>
</span>

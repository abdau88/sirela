...
ftb_userlist.lists["x_role"] = <?php echo $tb_user_list->role->Lookup->toClientList() ?>;
ftb_userlist.lists["x_role"].options = <?php echo JsonEncode($tb_user_list->role->options(FALSE, TRUE)) ?>;
...
<?php if ($tb_user->password->Visible) { // password ?>
	...
	<?php } else { ?>
		<th data-name="password" class="<?php echo $tb_user->password->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event,'<?php echo $tb_user->SortUrl($tb_user->password) ?>',1);"><div id="elh_tb_user_password" class="tb_user_password">
			<div class="ew-table-header-btn"><span class="ew-table-header-caption"><?php echo $tb_user->password->caption() ?></span><span class="ew-table-header-sort"><?php if ($tb_user->password->getSort() == "ASC") { ?><i class="fa fa-sort-up"></i><?php } elseif ($tb_user->password->getSort() == "DESC") { ?><i class="fa fa-sort-down"></i><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php if ($tb_user->role->Visible) { // role ?>
	<?php if ($tb_user->sortUrl($tb_user->role) == "") { ?>
		<th data-name="role" class="<?php echo $tb_user->role->headerCellClass() ?>"><div id="elh_tb_user_role" class="tb_user_role"><div class="ew-table-header-caption"><?php echo $tb_user->role->caption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="role" class="<?php echo $tb_user->role->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event,'<?php echo $tb_user->SortUrl($tb_user->role) ?>',1);"><div id="elh_tb_user_role" class="tb_user_role">
			<div class="ew-table-header-btn"><span class="ew-table-header-caption"><?php echo $tb_user->role->caption() ?></span><span class="ew-table-header-sort"><?php if ($tb_user->role->getSort() == "ASC") { ?><i class="fa fa-sort-up"></i><?php } elseif ($tb_user->role->getSort() == "DESC") { ?><i class="fa fa-sort-down"></i><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php
...
<span id="el<?php echo $tb_user_list->RowCnt ?>_tb_user_role" class="tb_user_role">
